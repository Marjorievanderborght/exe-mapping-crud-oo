        ...
        <div class="row">
            <div class="col-lg-12 mx-auto">
                ...
                <?php
                    ...
                    foreach ($afficherAllTheNews as $datas): ?>

                        <h4><?= $datas->getTheNewsTitle() ?></h4>
                        <p><?= ThenewsManager::cutTheText($datas->gettheNewsText(), 150) ?><a
                                href="?idarticle=<?= $datas->getidtheNews() ?>"> ... Lire la suite</a></p>
                        <h5>Par <a href="?idauteur=<?= $datas->gettheUser_idtheUser() ?>"> <?= $thenewsManager->selectTheUserLog($datas->getTheUser_idtheUser()) ?></a> le <?= $datas->gettheNewsDate() ?></h5>
                        <hr>
                    <?php endforeach;
                endif;
                ?>
